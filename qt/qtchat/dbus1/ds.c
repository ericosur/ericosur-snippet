// reference: http://www.matthew.ath.cx/misc/dbus
...
void sendsignal(char* sigvalue)
{
   ...
   // should not close a shared connection
...
void receive()
{
   ...
   int ret;
   char* sigvalue;
   const int MAX_MYSTR = 80;
   char mystr[MAX_MYSTR];
   ...
   while (true) {
      ...
      if ( !strncmp(mystr, "quit", MAX_MYSTR) || !strncmp(mystr, "exit", MAX_MYSTR)) {
         printf("command says quit...\n");
         break;
      }
   }
   // close the connection
