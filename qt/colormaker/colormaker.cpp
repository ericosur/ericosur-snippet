    ...
    , m_nColorTimer(0)
{
    ...
    connect(this, &ColorMaker::testSignal, this, &ColorMaker::testSlot, Qt::QueuedConnection);
}
...
QString ColorMaker::getData(QString qStr)
{
    std::cout << qStr.toStdString();
    return qStr;
}

bool ColorMaker::testSlot()
{
    qDebug() << "testSlot thread id : " << QThread::currentThreadId();
    return true;
}
