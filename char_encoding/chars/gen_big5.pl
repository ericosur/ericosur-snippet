...
#
# references:
# http://phi.sinica.edu.tw/tyuan/old.pages/pcfarm/old/docs/utf8-big5-comparison/report.html
# (backup) https://www.evernote.com/shard/s2/nl/120065/fa136361-58ec-41cd-8958-8746675d0d4e/
#
...
sub main()
{
    ...
    # print header
    print $ofh "# This file is generated by gen_big5.pl\n";
    ...
    my $cmd = "iconv -f BIG5-2003 -t UTF-8 $ofile > $uft8_file";
    print "cmd: ",$cmd,"\n";
    system $cmd;
}
