...
right = [
    ...
    # Chien-Shiung Wu is Chinese-American experimental physicist who made significant contributions to nuclear physics. https://en.wikipedia.org/wiki/Chien-Shiung_Wu
    "wu",
...
def get_random_name(retry=0):
    ...
    If retry is non-zero, a random integer between 0 and 10 will be 
...
if __name__ == "__main__":
    ...
    print("Random names:")
    for i in range(5):
        print(f"  {get_random_name()}")
    
    print("\nRandom names with retry numbers:")
    for i in range(5):
        print(f"  {get_random_name(retry=1)}")
